    ...
    <div className="section-container py-14 bg-gray-100">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-around items-center mt-12">
        {categoryItems.map((item, i) => (
          <div
            key={i}
            className="shadow-lg rounded-md bg-white hover:bg-green py-8 px-8 w-60 mx-auto text-center cursor-pointer hover:-translate-y-4 transition-all duration-300 z-10"
          >
            <div className="w-full  rounded-md md:items-center mx-auto flex items-center justify-center">
              <img
                src={item.image}
                alt=""
            ...
            <div className="mt-5 space-y-1">
              <h5 className="text-[#1E1E1E] hover:text-white font-semibold">
                {item.title}
              </h5>
